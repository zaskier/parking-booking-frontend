...
export default function PrivacyPolicy() {
  return (
    <main>
      ...
      Association's Model Code for the Protection of Personal Information and Canada's&nbsp;Personal
      ...
      We collect, use and disclose Personal Information to provide you with the product or service
      you have requested and to offer you additional products and services we believe you might be
      interested in. The purposes for which we collect Personal Information will be identified
      before or at the time we collect the information. In certain circumstances, the purposes for
      which information is collected may be clear, and consent may be implied, such as where your
      name, address and payment information is provided as part of the order process.
      <br />
      ...
      Information is always your choice. However, your decision not to provide certain information
      may limit our ability to provide you with our products or services. We will not require you to
      consent to the collection, use, or disclosure of information as a condition to the supply of a
      ...
      over the telephone or by corresponding with you via mail, facsimile, or the Internet.
      <br />
      ...
      Information will only be retained for the period of time required to fulfil the purpose for
      which we collected it or as may be required by law.&nbsp;(If applicable, include a description
      of any parties&nbsp;with whom you may share Personal Information.)
      <br />
      ...
      necessary to fulfil the purposes for which it is to be used.
      <br />
      ...
      sensitivity level of the information. We take all reasonable precautions to protect your
      Personal Information from any loss or unauthorized use, access or disclosure.
      <br />
      ...
      your Personal Information, and may request that it be amended, if appropriate. However, in
      certain circumstances permitted by law, we will not disclose certain information to you. For
      example, we may not disclose information relating to you if other individuals are referenced
      or if there are legal, security or commercial proprietary restrictions.
      <br />
      <a className="font-bold "> 10. Handling Customer Complaints and Suggestions</a>
      You may direct any questions or enquiries with respect to our privacy policy or our practices
      by
      <br />
      ...
      <br />A cookie is a small computer file or piece of information that may be stored in your
      computer's hard drive when you visit our websites. We may use cookies to improve our
      website&rsquo;s functionality and in some cases, to provide visitors with a customized online
      experience.
      <br />
      Cookies are widely used and most web browsers are configured initially to accept cookies
      ...
      policy will no longer apply once you leave our website. Additionally, we are not responsible
      for the privacy practices employed by third party websites. Therefore, we suggest that you
      examine the privacy statements of those sites to learn how your information may be collected,
